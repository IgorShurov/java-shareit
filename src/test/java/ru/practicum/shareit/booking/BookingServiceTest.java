...
public class BookingServiceTest extends Bookings {
    ...
    public void addBookingWhenBookerIsOwner() {
        ...
        assertThatThrownBy(
                //when
                () -> bookingService.addBooking(booking1Dto, user1.getId())
                //then
    ...
    public void addBookingWhenNotExistingBooker() {
        ...
        assertThatThrownBy(
                //when
                () -> bookingService.addBooking(booking1Dto, 99L)
                //then
    ...
    public void confirmationBooking() {
        ...
        var approvedBooking = bookingService
                .confirmationBooking(user1.getId(), savedBooking.getId(), true);
        var findBooking = bookingService
                .getBookingByIdAndBookerId(user2.getId(), savedBooking.getId());
        //then
    ...
    public void rejectBooking() {
        ...
        //when
        var approvedBooking = bookingService
                .confirmationBooking(user1.getId(), savedBooking.getId(), false);
        var findBooking = bookingService
                .getBookingByIdAndBookerId(user2.getId(), savedBooking.getId());
        //then
        assertThat(approvedBooking).usingRecursiveComparison().isEqualTo(findBooking);
    ...
    public void confirmationBookingWithNotExistingBooking() {
        ...
        assertThatThrownBy(
                //when
                () -> bookingService.confirmationBooking(user1.getId(), 99L, true)
                //then
    ...
    public void confirmationBookingWhenUserIsNotOwner() {
        ...
        assertThatThrownBy(
                //when
                () -> bookingService.confirmationBooking(user2.getId(), savedBooking.getId(), true)
                //then
        ).isInstanceOf(NotFoundException.class);
    }
    ...
    public void getBookingWhenBookingNotFound() {
        ...
        assertThatThrownBy(
                //when
                () -> bookingService.getBookingByIdAndBookerId(99L, user2.getId())
                //then
        ).isInstanceOf(UserNotFoundException.class);
    }
    ...
    public void getBookingWhenUserIsNotOwnerOrBooker() {
        ...
        assertThatThrownBy(
                //when
                () -> bookingService.getBookingByIdAndBookerId(savedBooking.getId(), 10L)
                //then
        ).isInstanceOf(BookingNotFoundException.class);
    }
    ...
    public void getAllBookingsForItemsUser() {
        ...
        List<Long> ids = findBookingList.stream().map(BookingOutDto::getId)
    ...
    public void getBookingListWithUnknownState() {
        userRepository.save(user1);
        assertThatThrownBy(
                () -> bookingService.getAllBrookingByBookerId(PageRequest.of(0, 10), user1.getId(), "qwe")
    ...
    public void getAllBookingsForUserWhenUserNotFound() {
        userRepository.save(user1);
        assertThatThrownBy(
                () -> bookingService.getAllBrookingByBookerId(PageRequest.of(0, 10), 50L, "ALL")
    ...
    public void getAllBookingsForItemsUserWhenUserNotFound() {
        ...
        addBookingsInDb();
        assertThatThrownBy(
                () -> bookingService.getAllBookingsForAllItemsByOwnerId(PageRequest.of(0, 10), 50L, "ALL")
        ).isInstanceOf(RuntimeException.class);
    }
    ...
    public void getAllBookingsForItemsUserWhenUserNotExistingBooking() {
        ...
        userRepository.save(user1);
        assertThatThrownBy(
                () -> bookingService.getAllBookingsForAllItemsByOwnerId(PageRequest.of(0, 10), user1.getId(), "ALL")
        ).isInstanceOf(RuntimeException.class);
    }
